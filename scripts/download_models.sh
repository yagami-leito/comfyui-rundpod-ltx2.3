...
# LTX-2.3 Sulphur Model fp8
aria2c -x 16 -s 16 -k 1M --dir="/workspace/runpod-slim/ComfyUI/models/diffusion_models" --out="ltx-2.3-22b-distilled-fp8.safetensors" "https://huggingface.co/Winnougan/Sulphur-2-LTX-2.3/resolve/main/sulphur_distill_fp8.safetensors?download=true"
